...
namespace BackgroundMusic.ViewModel
{
    ...
    public abstract class ViewModel : IViewModel
    {
        ...
        protected ViewModel()
        {
            ...
            initializationTask.ContinueWith(InitializationCompletedCallback);
    ...
    public abstract class ViewModel<TModel> : ViewModel, IViewModel<TModel> where TModel : class
    {
        ...
        public TModel Model
        {
            ...
            set
            {
                if (Model != value)
                {
                    ...
                    var oldValues = GetOldValues(allProperties);
                    var enumerator = oldValues.GetEnumerator();

                    model = value;

                    PropertyChangeOnAllProperties(allProperties, enumerator);
                }
            }
        }

        private void PropertyChangeOnAllProperties([NotNull] PropertyInfo[] allProperties, IEnumerator<object> enumerator)
        {
        ...
        private IEnumerable<object> GetOldValues(IEnumerable<PropertyInfo> properties)
        {
